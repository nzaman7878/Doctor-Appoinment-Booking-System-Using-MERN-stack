                ...
                {item.cancelled ? (
                  ...
                  <>
                    ...
                    <motion.button 
                      ...
                      className="w-10 h-10 flex items-center justify-center rounded-full bg-[var(--color-success-bg)] dark:bg-green-500/10 hover:bg-green-100 dark:hover:bg-green-500/20 text-[var(--color-success)] transition-colors"
                      title="Complete"
